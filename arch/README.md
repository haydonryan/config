...
# Post GUI packages
pacman -S firefox smartmontools gtest ipmitool vlc gnome-epub-thumbnailer tmux nmap go delve golang-golang-x-tools fzf the_silver_searcher ripgrep openvpn
pacman -S gnome-tweaks arduino arduino-cli bat openconnect cmake kicad jq
pacman -S docker
